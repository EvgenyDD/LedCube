...
extern uint8_t CUBE_DeviceDescriptor[CUBE_SIZ_DEVICE_DESC];
extern uint8_t CUBE_ConfigDescriptor[CUBE_SIZ_CONFIG_DESC];
extern uint8_t CUBE_ReportDescriptor[CUBE_SIZ_REPORT_DESC];
extern uint8_t CUBE_StringLangID[CUBE_SIZ_STRING_LANGID];
extern uint8_t CUBE_StringVendor[CUBE_SIZ_STRING_VENDOR];
extern uint8_t CUBE_StringProduct[CUBE_SIZ_STRING_PRODUCT];
